...
public class IntroPageTranfomer implements ViewPager.PageTransformer {
    @Override
    public void transformPage(View page, float position) {
        ...
        if (position <= -1.0f || position >= 1.0f) {
            ...
            View title = page.findViewById(R.id.ic_1);
            ...
            View description = page.findViewById(R.id.ic_2);
            ...
            View computer = page.findViewById(R.id.ic);
